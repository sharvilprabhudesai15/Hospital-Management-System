    ...
    private void Button1ActionPerformed(ActionEvent evt) {
        ...
        {   String currentVal = tt.getText();
            ...
            {   try
            {
                ...
                String s3="select * from view1 where medicineName like +'"+currentVal+"%'";
                ...
                jTable1.setModel(DbUtils.resultSetToTableModel(rs1));
                    ...
                    try {
                        ...
                        String sql="create or replace view view1 as select medicineID,medicineName from medicine_record";
