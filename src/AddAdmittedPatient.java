...
public class  AddAdmittedPatient  extends JFrame {
   ...
   private JTable jTable1;
    ...
    private void initComponents() {
        ...
        Label1.setBounds(350,300,1100,100);
...
//        j1.  setSize(1200,1200);         setLocation(400,5);         setLocation(400,5);
//        j1.add(Label1);
    ...
    private void Button4ActionPerformed(ActionEvent evt) {
       ...
       try{
              Class.forName("com.mysql.jdbc.Driver");
                ...
                String s3="INSERT INTO addadmitpatient (uniqueID,AdmitDate) values ('"+ttt.getText()+"','"+sd.format(d) +"')";               
                Statement stmt1 = conn1.createStatement();
                System.out.println(ttt.getText());
                stmt1.executeUpdate(s3);
                
                
                s3="INSERT INTO addalladmit (uniqueID,AdmitDate,DischargeDate) values ('"+ttt.getText()+"','"+sd.format(d) +"','')";               
