...
public class  DischargePatient  extends JFrame {
   ...
   private JTable jTable1;
    ...
    private void initComponents() {
        ...
        Label1.setText("PATIENT DISCHARGE");
       ...
       try{
            java.util.Date d =new java.util.Date();
              ...
              Class.forName("com.mysql.jdbc.Driver");
                ...
                String s3="delete from addadmitpatient where uniqueID = '"+ttt.getText()+"'";
                Statement stmt1 = conn1.createStatement();
                System.out.println(ttt.getText());
                stmt1.executeUpdate(s3);
                
                s3="UPDATE addalladmit set DischargeDate ='"+sd.format(d) + "' where UniqueID = '"+ttt.getText()+"'";
                stmt1.executeUpdate(s3);
            conn1.close();
            ttt.setText("");
