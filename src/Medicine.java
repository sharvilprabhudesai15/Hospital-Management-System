...
public class Medicine extends Frame {
    ...
    private void initComponents() {
        ...
        Label1.setText("MEDICINE RECORDS");

        Button1.setLabel("ADD MEDICINE DETAILS");
        ...
        Button2.setLabel("EDIT MEDICINE DETAIL");
        ...
        Button3.setLabel("DELETE MEDICINE DETAILS");
        ...
        Button4.setLabel("VIEW MEDICINE DETAIL");
    ...
    private void Button3ActionPerformed(ActionEvent evt) {
        ...
        DeleteMedicine obj=new DeleteMedicine();
        obj.setVisible(true);
        dispose();
