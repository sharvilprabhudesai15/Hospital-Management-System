...
public class  DeleteMedicine  extends JFrame {
   ...
   private JTable jTable1;
    ...
    private void initComponents() {
        ...
        Label1.setText("DELETE MEDICINE");
...
//        j1.setLayout(null);        j1.setLocation(400,5);
    ...
    private void Button4ActionPerformed(ActionEvent evt) {
       ...
       try{
                ...
                String s3="delete from Medicine_record where MedicineId = '"+ttt.getText()+"'";
    ...
    private void Button1ActionPerformed(ActionEvent evt) {
        ...
        {   String currentVal = tt.getText();
            ...
            {   try
            {
                ...
                Class.forName("com.mysql.jdbc.Driver");
                Connection conn1= DriverManager.getConnection("jdbc:mysql://localhost/hospital","root","");
                String s3="select * from medicine_record where medicineName like +'"+currentVal+"%'";
                Statement stmt1 = conn1.createStatement();
