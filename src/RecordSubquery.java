...
public class  RecordSubquery  extends JFrame {
    ...
    private void Button1ActionPerformed(ActionEvent evt) {
        ...
        {   String currentVal = tt.getText();
            ...
            {   try
            {
                ...
                String s3="select * from add_patient where name like +'"+currentVal+"%' and uniqueID not in (select uniqueID from addadmitpatient)";
                ...
                jTable1.setModel(DbUtils.resultSetToTableModel(rs1));
                    ...
                    try {
                        ...
                        String sql="select * from add_patient where uniqueID not in (select uniqueID from addadmitpatient)";
