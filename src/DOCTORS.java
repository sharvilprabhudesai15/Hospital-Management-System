...
public class DOCTORS extends Frame {
    ...
    private void initComponents() {
        ...
        Label1.setText("DOCTORS RECORDS");

        Button1.setLabel("ADD DOCTORS DETAILS");
        ...
        Button2.setLabel("EDIT DOCTORS DETAIL");
        ...
        Button3.setLabel("DELETE DOCTOR DETAILS");
        ...
        Button4.setLabel("VIEW DOCTORS DETAIL");
    ...
    private void Button4ActionPerformed(ActionEvent evt) {
        ...
        viewDoctorDetails2 obj =new viewDoctorDetails2();
        obj.setVisible(true);
        dispose();
    }
