...
public class  RecordJoin  extends JFrame {
    ...
    private void Button1ActionPerformed(ActionEvent evt) {
        ...
        {   String currentVal = tt.getText();
            ...
            {   try
            {
                ...
                String s3="select * from add_patient p,doctor_record d where d.doctor_id=p.doctor_id and name like +'"+currentVal+"%'";
                ...
                jTable1.setModel(DbUtils.resultSetToTableModel(rs1));
                    ...
                    try {
                        ...
                        String sql="select * from add_patient p,doctor_record d where d.doctor_id=p.doctor_id ";
